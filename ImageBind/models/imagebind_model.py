...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        ...
        """
        dict = torch.load("/cpfs01/user/lizihan/llama-adapter/imagebind-llm/output_dir/imagebind-10.pth")['model']
        for name in dict.keys():
            if name.startswith("image_bind."):
                dict[name.replace("image_bind.","")] = dict.pop(name)
